...
| Caller reference | Optional `externalReference` described as a free search field | `order_id` helps avoid duplicate payment; searchable `external_reference`; creation idempotency unknown | Unknown | Unknown | Unknown |
...
| Webhooks | Payment event POST; at-least-once delivery and stable duplicate event ID documented | `web_hook`/trigger configuration and event names documented; delivery semantics unknown | Unknown | Unknown | Unknown |
