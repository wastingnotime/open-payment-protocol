...
- Result: runtime started successfully; 17 observations emitted
- Evidence mode: deterministic documentation-derived simulation; not provider sandbox evidence

## Observed Runtime Shape

The runtime emitted `scenario_started`, one scheduled action, six scenario
...
partitioned without introducing six separate simulations.
...
All six scenarios currently run at the same simulated timestamp because this
