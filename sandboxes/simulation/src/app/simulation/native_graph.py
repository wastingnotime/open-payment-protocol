...
NODES = TOPOLOGY_NODES + (
    ...
    _scenario_node("iugu", "IUGU-PIX-018", "invoice due webhook event"),
    _scenario_node("iugu", "IUGU-PIX-019", "invoice payment failed webhook event"),
    _scenario_node("iugu", "IUGU-PIX-020", "invoice refund webhook event"),
    _scenario_node("iugu", "IUGU-PIX-021", "invoice rejected webhook event"),
    _scenario_node("iugu", "IUGU-PIX-022", "invoice partially refunded webhook event"),
    _scenario_node("iugu", "IUGU-PIX-023", "invoice refund reverted webhook event"),
    _scenario_node("iugu", "IUGU-PIX-024", "invoice created webhook event"),
    _scenario_node("iugu", "IUGU-PIX-025", "invoice released webhook event; funds relationship unknown"),
    ...
    _scenario_node("mercadopago", "MP-PIX-011", "processing order webhook notification"),
    _scenario_node("mercadopago", "MP-PIX-012", "order webhook signature rejected"),
    _scenario_node("mercadopago", "MP-PIX-013", "partial order refund"),
    _scenario_node("mercadopago", "MP-PIX-014", "total order refund"),
    ...
    _scenario_node("pagbank", "PB-PIX-016", "partial charge cancellation"),
    _scenario_node("pagbank", "PB-PIX-017", "full charge cancellation"),
...
TOPOLOGY_EDGES = (
    ...
    TopologyEdge("UC-IUGU-LIFECYCLE", "IUGU-PIX-018", "executes", "use_case_scenario"),
    TopologyEdge("UC-IUGU-LIFECYCLE", "IUGU-PIX-019", "executes", "use_case_scenario"),
    TopologyEdge("UC-IUGU-LIFECYCLE", "IUGU-PIX-020", "executes", "use_case_scenario"),
    TopologyEdge("UC-IUGU-LIFECYCLE", "IUGU-PIX-021", "executes", "use_case_scenario"),
    TopologyEdge("UC-IUGU-LIFECYCLE", "IUGU-PIX-022", "executes", "use_case_scenario"),
    TopologyEdge("UC-IUGU-LIFECYCLE", "IUGU-PIX-023", "executes", "use_case_scenario"),
    TopologyEdge("UC-IUGU-LIFECYCLE", "IUGU-PIX-024", "executes", "use_case_scenario"),
    TopologyEdge("UC-IUGU-LIFECYCLE", "IUGU-PIX-025", "executes", "use_case_scenario"),
    ...
    TopologyEdge("UC-MERCADOPAGO-CREATE-RECONCILE", "MP-PIX-011", "executes", "use_case_scenario"),
    TopologyEdge("UC-MERCADOPAGO-CREATE-RECONCILE", "MP-PIX-012", "executes", "use_case_scenario"),
    TopologyEdge("UC-MERCADOPAGO-CREATE-RECONCILE", "MP-PIX-013", "executes", "use_case_scenario"),
    TopologyEdge("UC-MERCADOPAGO-CREATE-RECONCILE", "MP-PIX-014", "executes", "use_case_scenario"),
    ...
    TopologyEdge("UC-PAGBANK-CREATE-CHARGE", "PB-PIX-016", "executes", "use_case_scenario"),
    TopologyEdge("UC-PAGBANK-CREATE-CHARGE", "PB-PIX-017", "executes", "use_case_scenario"),
...
KNOWN_EDGES = (
    ...
    GraphEdge("mercadopago", "MP-PIX-001", "MP-PIX-013", "partial_refund", "research/mercadopago/contract.md"),
    GraphEdge("mercadopago", "MP-PIX-001", "MP-PIX-014", "total_refund", "research/mercadopago/contract.md"),
    ...
    GraphEdge("pagbank", "PB-PIX-004", "PB-PIX-016", "partial_charge_cancellation", "research/pagbank/contract.md"),
    GraphEdge("pagbank", "PB-PIX-004", "PB-PIX-017", "full_charge_cancellation", "research/pagbank/contract.md"),
