...
| 2 | Mercado Pago, PagBank, Pagar.me, and Asaas create/retrieve increments | Resource hierarchy and provider differences | All five create/retrieve increments built; refine lifecycle next |
| 3 | Successful transition and native event | Timing, finality, event payload and delivery | Internal graph covers Iugu, PagBank, and Pagar.me; refine remaining providers |
